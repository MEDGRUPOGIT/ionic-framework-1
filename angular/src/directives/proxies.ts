...
@ProxyCmp({ inputs: ["buttonType", "color", "disabled", "download", "dsName", "dsSize", "expand", "fill", "href", "mode", "neutral", "rel", "routerAnimation", "routerDirection", "shape", "size", "strong", "target", "type"] })
@Component({ selector: "ion-button", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["buttonType", "color", "disabled", "download", "dsName", "dsSize", "expand", "fill", "href", "mode", "neutral", "rel", "routerAnimation", "routerDirection", "shape", "size", "strong", "target", "type"] })
