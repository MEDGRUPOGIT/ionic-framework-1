...
@ProxyCmp({ inputs: ["noAnimation", "singleOpen"] })
@Component({ selector: "accordion-group", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["noAnimation", "singleOpen"] })
...
@ProxyCmp({ inputs: ["background", "disable", "headerToggle", "open"] })
@Component({ selector: "accordion-item", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["background", "disable", "headerToggle", "open"] })
...
@ProxyCmp({ inputs: ["color", "defaultHref", "disabled", "dsColor", "dsName", "dsSize", "icon", "mode", "routerAnimation", "text", "type"] })
@Component({ selector: "ion-back-button", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["color", "defaultHref", "disabled", "dsColor", "dsName", "dsSize", "icon", "mode", "routerAnimation", "text", "type"] })
...
@ProxyCmp({ inputs: ["color", "disabled", "dsColor", "dsName", "mode", "outline"] })
@Component({ selector: "ion-chip", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["color", "disabled", "dsColor", "dsName", "mode", "outline"] })
...
@ProxyCmp({ inputs: ["activated", "closeIcon", "color", "disabled", "download", "dsColor", "dsName", "dsSize", "href", "mode", "neutral", "rel", "routerAnimation", "routerDirection", "show", "size", "target", "translucent", "type"] })
@Component({ selector: "ion-fab-button", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["activated", "closeIcon", "color", "disabled", "download", "dsColor", "dsName", "dsSize", "href", "mode", "neutral", "rel", "routerAnimation", "routerDirection", "show", "size", "target", "translucent", "type"] })
...
@ProxyCmp({ inputs: ["buffer", "color", "dsColor", "dsName", "mode", "percentage", "reversed", "type", "value"] })
@Component({ selector: "ion-progress-bar", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["buffer", "color", "dsColor", "dsName", "mode", "percentage", "reversed", "type", "value"] })
...
@ProxyCmp({ inputs: ["animated", "autocomplete", "autocorrect", "cancelButtonIcon", "cancelButtonText", "clearIcon", "color", "debounce", "disabled", "dsColor", "enterkeyhint", "inputmode", "mode", "placeholder", "searchIcon", "showCancelButton", "showClearButton", "spellcheck", "type", "value"], "methods": ["setFocus", "getInputElement"] })
@Component({ selector: "ion-searchbar", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["animated", "autocomplete", "autocorrect", "cancelButtonIcon", "cancelButtonText", "clearIcon", "color", "debounce", "disabled", "dsColor", "enterkeyhint", "inputmode", "mode", "placeholder", "searchIcon", "showCancelButton", "showClearButton", "spellcheck", "type", "value"] })
...
@ProxyCmp({ inputs: ["cancelText", "compareWith", "disabled", "dsColor", "interface", "interfaceOptions", "mode", "multiple", "name", "okText", "placeholder", "selectedText", "value"], "methods": ["open"] })
@Component({ selector: "ion-select", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["cancelText", "compareWith", "disabled", "dsColor", "interface", "interfaceOptions", "mode", "multiple", "name", "okText", "placeholder", "selectedText", "value"] })
...
@ProxyCmp({ inputs: ["background", "canCollapse", "dsColor", "icon", "isOpened", "noBorder", "slotsToggle"] })
@Component({ selector: "med-accordion-item", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["background", "canCollapse", "dsColor", "icon", "isOpened", "noBorder", "slotsToggle"] })
...
@Component({ selector: "med-cartao-resposta-lista", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>" })
...
@ProxyCmp({ inputs: ["dsColor", "text"] })
@Component({ selector: "med-divider", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "text"] })
...
@ProxyCmp({ inputs: ["dsName", "imagens"] })
@Component({ selector: "med-enunciado", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsName", "imagens"] })
...
export declare interface MedHeading extends Components.MedHeading {
}
@ProxyCmp({ inputs: ["dsColor", "dsName", "dsSize"] })
@Component({ selector: "med-heading", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "dsName", "dsSize"] })
...
@ProxyCmp({ inputs: ["button", "detail", "detailIcon", "disabled", "download", "dsColor", "href", "lines", "mode", "padding", "rel", "routerAnimation", "routerDirection", "target", "type"] })
@Component({ selector: "med-item", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["button", "detail", "detailIcon", "disabled", "download", "dsColor", "href", "lines", "mode", "padding", "rel", "routerAnimation", "routerDirection", "target", "type"] })
...
@ProxyCmp({ inputs: ["dsColor", "porcentagem", "professor", "videos"] })
@Component({ selector: "med-item-aulas", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "porcentagem", "professor", "videos"] })
...
@ProxyCmp({ inputs: ["dsColor", "inset", "lines", "mode", "padding"], "methods": ["closeSlidingItems"] })
@Component({ selector: "med-lista", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "inset", "lines", "mode", "padding"] })
...
export declare interface MedParagraph extends Components.MedParagraph {
}
@ProxyCmp({ inputs: ["dsColor", "dsName", "dsSize"] })
@Component({ selector: "med-paragraph", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "dsName", "dsSize"] })
...
@ProxyCmp({ inputs: ["dsColor", "dsName", "dsSize"] })
@Component({ selector: "med-subtitle", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor", "dsName", "dsSize"] })
...
export declare interface MedTabs extends Components.MedTabs {
}
@ProxyCmp({ inputs: ["dsColor"] })
@Component({ selector: "med-tabs", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor"] })
...
@ProxyCmp({ inputs: ["descricao", "dsColor", "titulo"] })
@Component({ selector: "med-titulo-materia", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["descricao", "dsColor", "titulo"] })
...
@ProxyCmp({ inputs: ["collapsed", "content", "dsColor", "dsName", "placement", "position", "titulo"], "methods": ["toggle"] })
@Component({ selector: "med-tooltip", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["collapsed", "content", "dsColor", "dsName", "placement", "position", "titulo"] })
...
export declare interface MedVideoListItem extends Components.MedVideoListItem {
}
@ProxyCmp({ inputs: ["dsColor"] })
@Component({ selector: "med-video-list-item", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["dsColor"] })
