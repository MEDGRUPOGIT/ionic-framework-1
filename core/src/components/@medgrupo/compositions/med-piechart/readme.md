...
| `hideDownload`     | `hide-download`     | Esconde o download do pie-chart.                                 | `boolean`                       | `false`     |
| `identification`   | `identification`    | Identificador do pie-chart para emissão de eventos.              | `number \| string \| undefined` | `undefined` |
