...
| `dsSize`  | `ds-size`  | Define a variação de tamanho do componente.                                                                                                                                                                                                                            | `"md" \| "sm" \| undefined` | `undefined` |
| `fill`    | `fill`     | Define a variação do componente.                                                                                                                                                                                                                                       | `"outline" \| undefined`    | `undefined` |
