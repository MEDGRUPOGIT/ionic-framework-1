...
export default {
  title: 'Components/Compositions/@OK Video Thumbnail',
...
VideoThumbnail.parameters = {
  design: {
    type: 'figma',
    url: 'https://www.figma.com/file/2j9jNt3PmQXpzD3IQJkyZe/Componentes?node-id=4303%3A21255',
  },
}
VideoThumbnail.argTypes = {
  dsColor: {
