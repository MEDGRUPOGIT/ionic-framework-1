...
<Meta title="Components/Core/Image Zoom/Usage" />

# Image Zoom

O Image Zoom utiliza os componente **ion-modal** e **ion-slides** como base.

- Documentação auxiliar ion-modal: **https://ionicframework.com/docs/api/modal**
- Documentação auxiliar ion-slides: **https://ionicframework.com/docs/api/slides**
