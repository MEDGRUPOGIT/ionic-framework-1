      ...
      <ion-content>
        ...
        <div class="monta-provas-filtro__wrap-title">
          ...
          <ion-button ds-name="tertiary" class="monta-provas-filtro__limpar">
            <ion-icon slot="icon-only" class="med-icon" name="med-limparfiltro"></ion-icon>
          </ion-button>
        </div>

        <med-accordion-list class="med-accordion-aulas monta-provas-filtro__accordion" single-open="true">

          <med-accordion-item class="monta-provas-filtro__accordion-item med-accordion-item--keep-border">
            <med-caption ds-size="base" ds-color="neutral-2" slot="start" class="monta-provas-filtro__accordion-title">
              <h3>Nome da Prova</h3>
            </med-caption>

            <div class="med-accordion-aulas__end monta-provas-filtro__accordion-icon" slot="end">
              <ion-button ds-name="tertiary" ds-size="xs">
                <ion-icon slot="icon-only" class="med-icon med-rotate monta-prova-filtro__icon" name="med-baixo"></ion-icon>
              </ion-button>
            </div>

            <div slot="content" class="monta-provas-filtro__content monta-provas-filtro__content-flex">
              <ion-input
                placeholder="Digite o nome da prova"
                class="monta-prova-filtro__input">
              </ion-input>
              <ion-button ds-name="tertiary" class="monta-provas-filtro__input-limpar">
                <ion-icon slot="icon-only" class="med-icon" name="med-fechar"></ion-icon>
              </ion-button>
            </div>
          </med-accordion-item>
          ...
          <med-accordion-item class="monta-provas-filtro__accordion-item med-accordion-item--keep-border">
            ...
            <div slot="content" class="monta-provas-filtro__content">
              ...
              <med-base radius="s08" ds-color="neutral-3" class="monta-prova-filtro__todas">
                <ion-checkbox slot="start"></ion-checkbox>
                <med-caption ds-size="sm" ds-color="neutral-10" slot="middle" class="monta-prova-filtro__todas-caption">
          ...
          <med-accordion-item class="monta-provas-filtro__accordion-item med-accordion-item--keep-border">
            ...
            <div slot="content" class="monta-provas-filtro__content">
              ...
              <med-list margin="sm">
                <med-list-item class="monta-prova-filtro__item-label" titulo="ABC" label="Faculdade de Medicina do ABC">
                  <ion-checkbox slot="start"></ion-checkbox>
                </med-list-item>

                <med-list-item class="monta-prova-filtro__item-label" titulo="AFAMCI" label="Associação Fluminense de Assistência a Mulher, a Criança e ao Idoso">
                  <ion-checkbox slot="start"></ion-checkbox>
                </med-list-item>

                <med-list-item class="monta-prova-filtro__item-label" titulo="AMP" label="Associação Médica do Paraná">
                  <ion-checkbox slot="start"></ion-checkbox>
                </med-list-item>

                <med-list-item class="monta-prova-filtro__item-label" titulo="AMRIGS" label="Associação Médica do Rio Grande do Sul">
                  <ion-checkbox slot="start"></ion-checkbox>
                </med-list-item>
              </med-list>
            </div>
          ...
          <med-accordion-item class="monta-provas-filtro__accordion-item med-accordion-item--keep-border">
            ...
            <div slot="content" class="monta-provas-filtro__content">
              <med-caption ds-size="sm" ds-color="neutral-10" class="monta-provas-filtro__accordion-header">
              ...
              <div class="monta-provas-filtro__search-terms">
                ...
                <ion-button ds-name="tertiary" class="monta-provas-filtro__search-limpar">
                  <ion-icon slot="icon-only" class="med-icon" name="med-mais-circulo"></ion-icon>
                </ion-button>
              </div>

              <div class="monta-provas-filtro__search-items">
                <span class="monta-provas-filtro__item-button">
                  <med-caption ds-size="sm" class="monta-provas-filtro__item-label">
                    <h3>Pediatria</h3>
                  </med-caption>
                  <ion-button ds-color="neutral-6" ds-name="primary" ds-size="xxs" class="">
                    <ion-icon slot="icon-only" class="med-icon" name="med-fechar"></ion-icon>
                  </ion-button>
                </span>
