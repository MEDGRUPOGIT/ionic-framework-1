    ...
    <ion-app>
      ...
      <ion-content class="duvidas">
        <div class="duvidas__content">
          ...
          <div class="card-duvidas card-duvidas--mostra-pergunta card-duvidas--resposta-oficial duvidas__card">
            <div class="card-duvidas__top">
              <ion-label class="card-duvidas__questao" token="p14x"> Em Questão 02 - 2018 UERJ </ion-label>
          ...
          <div class="card-duvidas card-duvidas--menos-informacao duvidas__card">
            <div class="card-duvidas__top">
              <ion-label class="card-duvidas__questao" token="p14x"> Em Questão 02 - 2018 UERJ </ion-label>
          ...
          <div class="card-duvidas card-duvidas--minha duvidas__card">
            <div class="card-duvidas__top">
              <ion-label class="card-duvidas__questao" token="p14x"> Em Questão 02 - 2018 UERJ </ion-label>
          ...
          <div class="card-duvidas card-duvidas--minha card-duvidas--mostra-pergunta card-duvidas--resposta-oficial duvidas__card">
            <div class="card-duvidas__top">
              <ion-label class="card-duvidas__questao" token="p14x"> Em Questão 02 - 2018 UERJ </ion-label>
