    ...
    <ion-app>
      <med-header>
        <med-navbar slot="navbar">
          ...
          <ion-label slot="title" token="p12x">2018 UERJ / Questão 02</ion-label>
          <ion-label slot="subtitle" token="p16b">DÚVIDAS ACADÊMICAS</ion-label>
        </med-navbar>
      </med-header>
      ...
      <ion-content div class="questao">
        <div class="questao__content">
