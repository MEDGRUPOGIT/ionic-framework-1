...
const createModalAjuda = async () => {
  modalController.create({
    component: 'ajuda-modal',
    cssClass: 'tp-modal',
  }).then((modal)=>{
    modal.present()
  });
    ...
    <ion-app>
      <med-header>
        <med-navbar slot="navbar">
          ...
          <ion-label slot="title" token="p16b">2022 R1
          SIM 01</ion-label>
          <ion-label slot="subtitle" token="p14">Geral 01</ion-label>
        </med-navbar>
      </med-header>

      <div class="resumo-top">
        <ion-item ds-color="brand" spacing-v="s08" spacing-h="s04" mode="ios" lines="none">
          <ion-button class="resumo-top__button" mode="ios" fill="clear" ds-color="neutral-10" ds-size="xxs" @click="${createModalRealizacoes}">
      ...
      <ion-content class="resumo">
        <div class="resumo__content">
          <div class="resumo__container">
            ...
            <div class="resumo__range-container">
              ...
              <div class="resumo__progress">
                <med-chart-bar-horizontal class="resumo__range" ds-color="fb-warning" hide-value label="false">
      ...
      <ion-footer class="resumo-bottom">
        <ion-item ds-color="neutral-2" gap="s08" spacing-v="s08" spacing-h="s16" mode="ios" lines="none" detail="false">
          ...
          <div class="resumo-bottom__modo-container">
            <ion-button class="resumo-bottom__modo" mode="ios" @click="${createModalTutorial}">
              MODO PROVA
            </ion-button>
            <ion-button class="resumo-bottom__modo" mode="ios" @click="${createModalAviso}">
              MODO ESTUDO
            </ion-button>
          </div>
        </ion-item>
