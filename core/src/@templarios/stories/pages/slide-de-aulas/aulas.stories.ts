    ...
    <div class="container">
      <med-header>
        <med-navbar class="header" slot="navbar">
          ...
          <ion-label class="header__title" slot="title" token="p14">medcode</ion-label>
        </med-navbar>
      ...
      <main class="content aulas">
        <med-base class="aulas__item aulas__item" ds-color="neutral-25">
          ...
          <div class="aulas__middle middle" slot="middle">
            ...
            <div class="aulas__observacao-container">
              <ion-label class="aula__observacao" ds-color="neutral-8" token="p14">Deixe sua observação</ion-label>

              <ion-label class="aula__erro" ds-color="fb-warning" token="p12">Mensagem de erro</ion-label>
              </div>
          </div>
        ...
        <med-base class="aulas__item aulas__item--avaliada" ds-color="neutral-25">
          ...
          <div class="aulas__middle middle" slot="middle"></div>
          <div class="aulas__bottom" slot="end">
            <img class="aulas__image" src="https://via.placeholder.com/500">
          </div>
        </med-base>
