...
export default {
  title: "Components/CSS Framework/Input",
...
const Template = ({ "ds-color": dsColor, "ds-name": dsName, disabled, state }) => {
  return html`
    ...
    <div tp-container-input ds-color=${dsColor} ds-name=${dsName} ?disabled=${disabled} state=${state}>
      <ion-icon class="med-icon med-icon--alerta med-icon--start" name="med-alerta"></ion-icon>
      <button
        tp-button
        icon-only
        fill="clear"
    ...
    <div tp-container-input ds-color=${dsColor} ds-name=${dsName} ?disabled=${disabled} state=${state}>
      ...
      <ion-icon class="med-icon med-icon--alerta med-icon--end" name="med-alerta"></ion-icon>
    </div>
