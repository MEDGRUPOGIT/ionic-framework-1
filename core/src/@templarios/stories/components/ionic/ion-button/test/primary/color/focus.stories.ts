    ...
    <ion-app>
      <ion-content>
        ${Object.values(MedColors).map(color => {
          return html`
            <ion-button class="ion-focused" mode="ios" ds-color=${color}>Button</ion-button>
          `
        })}

        ${Object.values(MedColors).map(color => {
          return html`
            <ion-button class="ion-focused" mode="ios" ds-color=${color}>
        ...
        ${Object.values(MedColors).map(color => {
          return html`
            <ion-button class="ion-focused" icon-only mode="ios" ds-color=${color}>
