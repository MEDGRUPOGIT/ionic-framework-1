...
export function modalEnterAnimationSheetMobile(baseEl: any) {
...
export function modalEnterAnimationSheetDesktop(baseEl: any) {
  const backdropAnimation = createAnimation()
...
export function modalLeaveAnimationSheetMobile(baseEl: any) {
  return modalEnterAnimationSheetMobile(baseEl).direction('reverse');
}

export function modalLeaveAnimationSheetDesktop(baseEl: any) {
